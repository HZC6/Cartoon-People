...
#import "CAViewCell.h"
@interface CPThemeViewController ()<UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>

@end

@implementation CPThemeViewController
...
- (void)loadData{
    NSString *path = [[NSBundle mainBundle]pathForResource:@"区域" ofType:@"json"];
